...
set TEST_NAME="Ext XML -> load to server infobase (designer)"
set TEST_OUT_PATH=%OUT_PATH%\%~n0
set TEST_OUT_PATH=%TEST_OUT_PATH: =_%
set TEST_CHECK_PATH=%TEST_OUT_PATH%\DataProcessors\Расш1_Обработка2.xml
...
echo [INFO] Creating temporary infobase "%V8_SRV_ADDR%:%V8_SRV_REG_PORT%\%TMP_IB_NAME%"
...
call %SCRIPTS_PATH%\conf2ib.cmd "%TEST_XML_CF%" "/S%V8_SRV_ADDR%:%V8_SRV_REG_PORT%\%TMP_IB_NAME%"

call %SCRIPTS_PATH%\ext2ib.cmd "%TEST_BINARY%\Расширение1.cfe" "/S%V8_SRV_ADDR%:%V8_SRV_REG_PORT%\%TMP_IB_NAME%" "Расширение1"

call %SCRIPTS_PATH%\ext2xml.cmd "/S%V8_SRV_ADDR%:%V8_SRV_REG_PORT%\%TMP_IB_NAME%" "%TEST_OUT_PATH%" "Расширение1"
