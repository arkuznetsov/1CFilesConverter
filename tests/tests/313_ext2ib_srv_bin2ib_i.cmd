...
set TEST_NAME="Ext CFE -> load to server infobase (ibcmd)"
...
call %SCRIPTS_PATH%\conf2ib.cmd "%TEST_BINARY%\1cv8.cf" "/S%V8_DB_SRV_ADDR%\%TMP_IB_NAME%"

call %SCRIPTS_PATH%\ext2ib.cmd "%TEST_BINARY%\Расширение1.cfe" "/S%V8_DB_SRV_ADDR%\%TMP_IB_NAME%" "Расширение1"

call %SCRIPTS_PATH%\ext2xml.cmd "/S%V8_DB_SRV_ADDR%\%TMP_IB_NAME%" "%TEST_OUT_PATH%" "Расширение1"
