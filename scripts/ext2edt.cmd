...
echo [INFO] Loading configuration extension from file "%EXT_SOURCE%" to infobase "%IB_PATH%"...
...
echo [INFO] Export configuration extension from 1C:Designer XML format "%XML_PATH%" to 1C:EDT format "%EXT_DEST_PATH%"...
