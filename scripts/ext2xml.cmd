...
IF not defined V8_SRC_PATH (
    echo [ERROR] Missed parameter 1 - "infobase, path to folder contains 1C extension binary file (*.cfe) or EDT project"
    set ERROR_CODE=1
)
...
IF %ERROR_CODE% neq 0 (
    ...
    echo     %%1 - infobase, path to folder contains 1C extension binary file ^(*.cfe^) or EDT project
...
echo Infobase, configuration extension binary ^(*.cfe^) or folder containing configuration extension 1C:EDT project expected.
set ERROR_CODE=1
goto finally
